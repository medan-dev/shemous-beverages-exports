              ...
              >
                <div style={{ height: '100%', width: '100%', background: 'transparent', position: 'absolute', top: 0, left: 0 }}>
                  ...
                  <motion.div
                    ...
                    style={{ zIndex: 2, position: 'absolute', width: '100%', height: '100%', top: 0, left: 0 }}
                  >
                    <img 
          ...
          <div className="hero-split-grid" style={{ alignItems: 'center' }}>
            ...
            <div style={{ paddingRight: '4rem' }}>
              ...
              <div style={{ fontSize: '1.2rem', color: 'var(--text-muted)', lineHeight: 1.8, fontWeight: 450 }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(min(100%, 200px), 1fr))', gap: '1.5rem', marginTop: '4rem' }}>
